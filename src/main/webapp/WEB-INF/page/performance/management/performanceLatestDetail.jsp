			...
			<div id="content" class="col-lg-10 col-sm-10">
				...
				<div class="box col-md-12">
						<div class="box-inner">
							...
							<div class="panel panel-default"  style="border:1px solid black">	
								 <div class="panel-body" >										
										<label class="col-lg-2" style="text-align:right; vertical-align:middle;display:inline-block;line-height:75px;">SelfAssessment</label>
										<div class="col-lg-10">
...
<div class="ch-container ">
	...
	<script type="text/javascript" src="<%=path %>/js/pmo/performance/management/performanceLatestDetail.js"></script>
