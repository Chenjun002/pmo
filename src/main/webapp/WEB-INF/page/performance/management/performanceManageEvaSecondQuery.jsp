				...
				<div class="box col-md-12">
						<div class="box-inner" >
							...
							<div class="panel panel-default"  style="border:1px solid black">	
                                ...
                                <input id="restate" type="hidden" value="${state}"></input>
								<div class="form-group" >
									    <div style="text-align:center;width:20%;float:left"   >
									    <input type="button" value="Reject"
										name="searchBtn" id="button1" href="#" onClick="approval(3);"
										class="button btn btn-primary" data-dismiss="modal"
										style="background-color: #D5D5D5; border: 0 none; border-radius: 4px; color: #FFFFFF; cursor: pointer; display: inline-block; font-size: 15px; font-weight: bold; height: 32px; line-height: 32px; margin: 0 5px 10px 0; padding: 0; text-align: center; text-decoration: none; vertical-align: top; white-space: nowrap; width: 100px; margin:auto ;">
									    </div>
									    <div style="text-align:left;width:80%;float:left">
									    <input id="button2" type="button" value="Approve" href="#" onClick="approval(4);"
										class="button btn btn-primary" data-dismiss="modal"
										style="background-color: #D5D5D5; border: 0 none; border-radius: 4px; color: #FFFFFF; cursor: pointer; display: inline-block; font-size: 15px; font-weight: bold; height: 32px; line-height: 32px; margin: 0 5px 10px 0; padding: 0; text-align: center; text-decoration: none; vertical-align: top; white-space: nowrap; width: 100px; margin:auto ;">
									    </div>
								</div>
