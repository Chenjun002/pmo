						...
						<div class="box-inner">
							...
							<div class="panel panel-default"  style="border:1px solid black">	
								 <div class="panel-body" >										
										...
										<div class="col-lg-10">
											<textarea rows="3" style="border:1px solid black" class="form-control" id="perSettingComments" ></textarea>
										</div>
								 </div>
							</div>
...
<div class="ch-container ">
	...
	<script type="text/javascript" src="<%=path %>/js/pmo/performance/management/performanceDetail.js"></script>
