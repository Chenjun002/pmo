				...
				<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-user"></i>  Management-Details
								</h2>
							</div>
							...
							<div class="panel panel-default"  style="border:1px solid black">	
								 <div class="panel-body" >										
										...
										<div class="col-lg-10">
											<textarea rows="3" style="border:1px solid black" class="form-control" id="initialEvaluation" ></textarea>
										</div>
								 </div>
							</div>
								...
								<div class="form-group">
									   <div style="text-align:center;width:100%;">
									    <input type="button" value="Ok" name="Ok" id="Ok" href="#"
										class="button btn btn-primary" data-dismiss="modal"
										onclick="ok()"
										style="background-color: #D5D5D5; border: 0 none; border-radius: 4px; color: #FFFFFF; cursor: pointer; display: inline-block; font-size: 15px; font-weight: bold; height: 32px; line-height: 32px; margin: 0 5px 10px 0; padding: 0; text-align: center; text-decoration: none; vertical-align: top; white-space: nowrap; width: 100px; margin:auto ;">
									    <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
									    <input type="button" value="Cancel" name="Cancel" id="Cancel" href="#"
										class="button btn btn-primary" data-dismiss="modal"
										onclick="cancel()"
										style="background-color: #D5D5D5; border: 0 none; border-radius: 4px; color: #FFFFFF; cursor: pointer; display: inline-block; font-size: 15px; font-weight: bold; height: 32px; line-height: 32px; margin: 0 5px 10px 0; padding: 0; text-align: center; text-decoration: none; vertical-align: top; white-space: nowrap; width: 100px; margin:auto ;">
										<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="ch-container ">
	...
	<script type="text/javascript" src="<%=path %>/js/pmo/performance/management/performanceApprovalDetail.js"></script>
