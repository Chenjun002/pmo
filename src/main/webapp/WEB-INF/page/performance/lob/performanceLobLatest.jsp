				...
				<div class="box col-md-12">
						<div class="box-inner" >
							...
							<input type="hidden" id="showAchievement" value="true"></input>
								<h2>
									<i class="glyphicon glyphicon-user"></i>   LOB-Assessment Result-Latest Performance
								</h2>
							</div>
...
<div class="ch-container ">
	...
	<script type="text/javascript" src="<%=path %>/js/pmo/performance/lob/performanceLobLatest.js"></script>
</body>
</html>
