				...
				<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-user"></i>  Employee Self-Assessment
								</h2>
							</div>
							...
							<div class="panel panel-default">	
                             ...
                             <table id="table1" border="1" width="100%" class="templateTable">
                               ...
                               <tr style="display:none">
                                 <td colspan="7"><button id="button1" href='javascript:void(0);' class='btn btn-info btn-sm' onclick="addTr1('table1', -1, 6);")><span class="glyphicon glyphicon-plus"></span> Add</button>
								 </td>
                               </tr>
                             </table>
                             ...
                             <table id="table2" border="1" width="100%" class="templateTable">
                               ...
                               <tr style="display:none">
                                 <td colspan="7"><button id="button2" href='javascript:void(0);' class='btn btn-info btn-sm' onclick="addTr2('table2', -1, 7);")><span class="glyphicon glyphicon-plus"></span> Add</button>
								 </td>
                               </tr>
							 </table>
