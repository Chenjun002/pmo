...
<body>
	...
	<c:import url="/service/performance/performanceLeft">
	    <c:param name="currentPageName" value="<%=currentPageName%>"/>
            ...
            <input type="hidden" value="${employeeid}" id="reemployeeid"></input>
            <input type="hidden" value="${year}" id="reyear"></input>
            <input type="hidden" value="${quarter}" id="requarter"></input>
				...
				<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-user"></i>  Employee-Performance History Details
								</h2>
							</div>
...
<div class="ch-container ">
	...
	<script type="text/javascript" src="<%=path %>/js/pmo/performance/employee/employeePerformanceHistoryDetail.js"></script>
